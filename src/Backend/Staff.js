...
const Staff = () => {
    ...
    const getInfoList = () => {
        Apiconnect.getData('users/stafflist').then((response) => {
    ...
    const deleteItem = (id) => {
        console.log(id);
        Apiconnect.getData(`users/deletestaff/${id}`).then((response) => {
            getInfoList();
    ...
    return (
        <>
            <div className="card-body cbtop">
                <h2>Team List</h2>
                <Link to="/admin/staff/add" className="btn btn-success midbtn">
                        ...
                        {List.map((val, key) => {
                            return (
                                <tr key={key}>
                                    ...
                                    <td>
                                        <Link to={`/admin/staff/edit/${val.id}`} className="btn btn-primary mybtn">
