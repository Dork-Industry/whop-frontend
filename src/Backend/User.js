...
const User = () => {
    ...
    const getInfoList = () => {
        Apiconnect.getData('users/userlist').then((response) => {
    ...
    const deleteItem = (id) => {
        console.log(id);
        Apiconnect.getData(`users/deleteuser/${id}`).then((response) => {
            getInfoList();
    ...
    return (
        <>
            <div className="card-body cbtop">
                <h2>Customer List</h2>
                <Link to="/admin/user/add" className="btn btn-success midbtn">
                        ...
                        {List.map((val, key) => {
                            return (
                                <tr key={key}>
                                    ...
                                    <td>
                                        <Link to={`/admin/user/edit/${val.id}`} className="btn btn-primary mybtn">
